class FolderNames:
    ...
    RES_QA_RELEVANCE_CHECK_DIR = "s1_qa_relevance_check"
    RES_ARCH_RELEVANCE_CHECK_DIR = "s2_arch_relevance_check"
    RES_TACTIC_EXTRACTION_DIR = "s3_tactic_extraction"
